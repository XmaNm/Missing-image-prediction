...
def main(args):
    ...
    # customized dataset
    train_data = createData.myDataset(txt='train.txt', transform=transforms.ToTensor())
    test_data = createData.myDataset(txt='test.txt', transform=transforms.ToTensor())
    train_loader = torch.utils.data.DataLoader(dataset=train_data, batch_size=batch_size, shuffle=True, num_workers=4)
    val_loader = createData.DataLoader(dataset=test_data, batch_size=batch_size, shuffle=False, num_workers=4)
